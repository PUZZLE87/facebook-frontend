    ...
    <div>
        ...
        <div className="flex space-x-3 ">
          ...
          <div className="leading-4">
            ...
            <div className="flex flex-col items-stretch mt-2 space-y-1">
              <label className="p-2 flex items-center justify-between text-gray-900 font-bold text-lg cursor-pointer hover:bg-gray-200 rounded-lg transition-colors">
                <span>On</span>
      ...
      <div className="flex justify-between px-1  py-2 cursor-pointer hover:bg-gray-200 transition-colors rounded-lg">
        <div className="flex items-center space-x-3">
          ...
          <div className="text-gray-800 font-bold">Keyboard</div>
        </div>
